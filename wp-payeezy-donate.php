...
echo '<p><label>Comment</label><input name="x_description" value="" type="text"></p>';
...
echo '<br>';
echo '<br>';
echo '<p><input type="checkbox" name="recurring" value="TRUE">&nbsp;Automatically repeat this donation once a month, beginning in 30 days.<br>';
echo '<br>';
